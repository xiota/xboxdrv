...
void AxisEvent::add_filter(AxisFilterPtr filter) {
...
void AxisEvent::set_axis_range(int min, int max) {
  m_min = min;
  m_max = max;
...
void AxisEventHandler::set_axis_range(int min, int max) {
  m_min = min;
  m_max = max;
}
