...
UInputOptions::UInputOptions() : m_btn_map(), m_axis_map() {
  set_defaults();
}

ButtonMap &UInputOptions::get_btn_map() {
  return m_btn_map;
}

AxisMap &UInputOptions::get_axis_map() {
  return m_axis_map;
}

const ButtonMap &UInputOptions::get_btn_map() const {
  return m_btn_map;
}

const AxisMap &UInputOptions::get_axis_map() const {
  return m_axis_map;
}
...
void UInputOptions::mimic_xpad() {
  ...
  // Axis Mapping
  get_axis_map().bind(
      XBOX_AXIS_X1, AxisEvent::create_abs(DEVICEID_JOYSTICK, ABS_X, -32768, 32767, 16, 128)
  );
  get_axis_map().bind(
      XBOX_AXIS_Y1, AxisEvent::create_abs(DEVICEID_JOYSTICK, ABS_Y, -32768, 32767, 16, 128)
  );
  get_axis_map().bind(
      XBOX_AXIS_X2, AxisEvent::create_abs(DEVICEID_JOYSTICK, ABS_RX, -32768, 32767, 16, 128)
  );
  get_axis_map().bind(
      XBOX_AXIS_Y2, AxisEvent::create_abs(DEVICEID_JOYSTICK, ABS_RY, -32768, 32767, 16, 128)
  );
  get_axis_map().bind(
      XBOX_AXIS_LT, AxisEvent::create_abs(DEVICEID_JOYSTICK, ABS_Z, 0, 255, 0, 0)
  );
  get_axis_map().bind(
      XBOX_AXIS_RT, AxisEvent::create_abs(DEVICEID_JOYSTICK, ABS_RZ, 0, 255, 0, 0)
  );
  get_axis_map().bind(
      XBOX_AXIS_DPAD_X, AxisEvent::create_abs(DEVICEID_JOYSTICK, ABS_HAT0X, -1, 1, 0, 0)
  );
  get_axis_map().bind(
      XBOX_AXIS_DPAD_Y, AxisEvent::create_abs(DEVICEID_JOYSTICK, ABS_HAT0Y, -1, 1, 0, 0)
  );
}
...
void UInputOptions::mimic_xpad_wireless() {
  ...
  get_btn_map().bind(
      XBOX_DPAD_UP, ButtonEvent::create_key(DEVICEID_JOYSTICK, BTN_TRIGGER_HAPPY3)
  );
  get_btn_map().bind(
      XBOX_DPAD_DOWN, ButtonEvent::create_key(DEVICEID_JOYSTICK, BTN_TRIGGER_HAPPY4)
  );
  get_btn_map().bind(
      XBOX_DPAD_LEFT, ButtonEvent::create_key(DEVICEID_JOYSTICK, BTN_TRIGGER_HAPPY1)
  );
  get_btn_map().bind(
      XBOX_DPAD_RIGHT, ButtonEvent::create_key(DEVICEID_JOYSTICK, BTN_TRIGGER_HAPPY2)
  );
...
void UInputOptions::set_defaults() {
  ...
  // Axis Mapping
  get_axis_map().bind(
      XBOX_AXIS_X1, AxisEvent::create_abs(DEVICEID_AUTO, ABS_X, -32768, 32767, 0, 0)
  );
  get_axis_map().bind(
      XBOX_AXIS_Y1, AxisEvent::create_abs(DEVICEID_AUTO, ABS_Y, -32768, 32767, 0, 0)
  );
  get_axis_map().bind(
      XBOX_AXIS_X2, AxisEvent::create_abs(DEVICEID_AUTO, ABS_RX, -32768, 32767, 0, 0)
  );
  get_axis_map().bind(
      XBOX_AXIS_Y2, AxisEvent::create_abs(DEVICEID_AUTO, ABS_RY, -32768, 32767, 0, 0)
  );
  get_axis_map().bind(
      XBOX_AXIS_LT, AxisEvent::create_abs(DEVICEID_AUTO, ABS_BRAKE, 0, 255, 0, 0)
  );
  get_axis_map().bind(
      XBOX_AXIS_RT, AxisEvent::create_abs(DEVICEID_AUTO, ABS_GAS, 0, 255, 0, 0)
  );
  ...
  get_axis_map().bind(
      XBOX_AXIS_DPAD_X, AxisEvent::create_abs(DEVICEID_AUTO, ABS_HAT0X, -1, 1, 0, 0)
  );
  get_axis_map().bind(
      XBOX_AXIS_DPAD_Y, AxisEvent::create_abs(DEVICEID_AUTO, ABS_HAT0Y, -1, 1, 0, 0)
  );
}
...
void UInputOptions::trigger_as_zaxis() {
  get_axis_map().bind(
      XBOX_AXIS_TRIGGER, AxisEvent::create_abs(DEVICEID_AUTO, ABS_Z, -255, 255, 0, 0)
  );
  get_axis_map().bind(XBOX_AXIS_LT, AxisEvent::invalid());
  get_axis_map().bind(XBOX_AXIS_RT, AxisEvent::invalid());
}
...
void UInputOptions::dpad_only() {
  ...
  get_axis_map().bind(
      XBOX_AXIS_DPAD_X, AxisEvent::create_abs(DEVICEID_AUTO, ABS_X, -1, 1, 0, 0)
  );
  get_axis_map().bind(
      XBOX_AXIS_DPAD_Y, AxisEvent::create_abs(DEVICEID_AUTO, ABS_Y, -1, 1, 0, 0)
  );
}
...
void UInputOptions::guitar() {
  ...
  // Axis Mapping
  get_axis_map().bind(
      XBOX_AXIS_X2, AxisEvent::create_abs(DEVICEID_AUTO, ABS_X, -32768, 32767, 0, 0)
  );  // whammy
  get_axis_map().bind(
      XBOX_AXIS_Y2, AxisEvent::create_abs(DEVICEID_AUTO, ABS_Y, -32768, 32767, 0, 0)
  );  // tilt
