...
void UInputConfig::update(int msec_delta) {
...
void UInputConfig::send_button(XboxButton code, bool value) {
...
void UInputConfig::reset_all_outputs() {
...
void UInputConfig::send_axis(XboxAxis code, int32_t value) {
